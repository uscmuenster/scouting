...
```bash
python Scouting/scripts/update_lineups.py --limit 3
```
...
Mit `Scouting/scripts/update_international_matches.py` aggregierst du Champions-League-, Cup- und Challenge-Cup-Partien deutscher Teams direkt von der CEV. Das Ergebnis ist eine eigenständige HTML-Seite mit:

* Wettbewerbsübersichten inklusive Quellenlink zur jeweiligen CEV-Landingpage.
* Auflistungen kommender und abgeschlossener Spiele pro Team, inklusive Terminangaben, Austragungsort, Match-Centre-Links und Satzergebnissen. 【F:Scouting/scripts/update_international_matches.py†L91-L226】【F:Scouting/scripts/update_international_matches.py†L228-L324】
